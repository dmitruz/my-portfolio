...
$mail->addAddress('dmitruz970@gmail.com');     // Кому будет уходить письмо
...
$mail->Subject = 'You have contact from portfolio';
$mail->Body    = '' .$name . ' left contacts, his telephone ' .$phone. '<br>email of this user: ' .$email;
$mail->AltBody = '';
